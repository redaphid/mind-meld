...
- includeNoise: bring the hidden and demoted material back (default false).`,
    {
      ...
      includeAutomated: z.boolean().optional().describe('Include automated, non-interactive sessions (Slack monitoring, curiosity curation, MCP health checks, huddle transcripts). Excluded by default. They are part of the noise corpus, so this also switches off the ranking penalty that demotes results resembling noise.'),
